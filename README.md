...
- 🕶️ **Arama sorguları kaydedilmez** — arama geçmişi veya telemetri oluşturulmaz.
- ♻️ **Otomatik indeksleme** — erişilebilir belgeler uygulama tarafından taranır.

## 📁 Arama Alanları

Aramayı **Bilgisayarın Tümü** üzerinde sürdürebilir veya **Sadece Belirli Klasörler** ile sınırlandırabilirsiniz.

İstediğiniz klasörleri aramaya dahil edebilir, istemediklerinizi ayrıca hariç tutabilirsiniz. USB, harici HDD ve SSD içindeki klasörler de normal **Klasör Ekle** akışıyla kullanılabilir.
...
MetinBul **local-first** çalışır. Belge içerikleri cihazınızda işlenir ve arama amacıyla harici bir sunucuya gönderilmez. Arama sorgularınız kaydedilmez; arama geçmişi veya telemetri oluşturulmaz.
